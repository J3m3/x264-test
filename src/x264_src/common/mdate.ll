...
define dso_local noundef i64 @x264_mdate() local_unnamed_addr #0 !dbg !9 {
entry:
  ret i64 1, !dbg !17
}
...
!1 = !DIFile(filename: "x264_src/common/mdate.c", directory: "/home/yjs/workspace/x264-test/src", checksumkind: CSK_MD5, checksum: "1848a12bc0d7985e75b5b65d23df0c63")
...
!9 = distinct !DISubprogram(name: "x264_mdate", scope: !1, file: !1, line: 25, type: !10, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0)
...
!17 = !DILocation(line: 27, column: 4, scope: !9)
